...
export default {
  ...
  //       // 如果通过watch监听bannerList属性的属性值的变化
  //       // 执行handler方法，代表组件实例身上这个属性的属性值已经有了【数组：四个元素】
  ...
  mounted() {
    ...
    this.$store.dispatch('homeAbout/getBannderList')
    // 为什么swiper实例在mounted当中直接书写不可以：因为这是用到了axios异步请求数据，数据还没有渲染完成
  }
}
</script>
